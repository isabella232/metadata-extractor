...
public abstract class ExifDirectoryBase extends Directory
{
    ...
    protected static void addExifTagNames(HashMap<Integer, String> map)
    {
        ...
        map.put(TAG_DNG_VERSION, "DNG Version");
        map.put(TAG_DNG_BACKWARD_VERSION, "DNG Backward Version");
        map.put(TAG_UNIQUE_CAMERA_MODEL, "Unique Camera Model");
        map.put(TAG_LOCALIZED_CAMERA_MODEL, "Localized Camera Model");
        map.put(TAG_CFA_PLANE_COLOR, "CFA Plane Color");
        map.put(TAG_CFA_LAYOUT, "CFA Layout");
        map.put(TAG_LINEARIZATION_TABLE, "Linearization Table");
        map.put(TAG_BLACK_LEVEL_REPEAT_DIM, "Black Level Repeat Dim");
        map.put(TAG_BLACK_LEVEL, "Black Level");
        map.put(TAG_BLACK_LEVEL_DELTA_H, "Black Level Delta H");
        map.put(TAG_BLACK_LEVEL_DELTA_V, "Black Level Delta V");
        map.put(TAG_WHITE_LEVEL, "White Level");
        map.put(TAG_DEFAULT_SCALE, "Default Scale");
        map.put(TAG_BEST_QUALITY_SCALE, "Best Quality Scale");
        map.put(TAG_DEFAULT_CROP_ORIGIN, "Default Crop Origin");
        map.put(TAG_DEFAULT_CROP_SIZE, "Default Crop Size");
        map.put(TAG_CALLIBRATION_ILLUMINANT_1, "Callibration Illuminant 1");
        map.put(TAG_CALLIBRATION_ILLUMINANT_2, "Callibration Illuminant 2");
        map.put(TAG_COLOR_MATRIX_1, "Color Matrix 1");
        map.put(TAG_COLOR_MATRIX_2, "Color Matrix 2");
        map.put(TAG_CAMERA_CALIBRATION_1, "Camera Calibration 1");
        map.put(TAG_CAMERA_CALIBRATION_2, "Camera Calibration 2");
        map.put(TAG_REDUCTION_MATRIX_1, "Reduction Matrix 1");
        map.put(TAG_REDUCTION_MATRIX_2, "Reduction Matrix 2");
        map.put(TAG_ANALOG_BALANCE, "Analog Balance");
        map.put(TAG_AS_SHOT_NEUTRAL, "As Shot Neutral");
        map.put(TAG_AS_SHOT_WHITE_X_Y, "As Shot White X Y");
        map.put(TAG_BASELINE_EXPOSURE, "Baseline Exposure");
        map.put(TAG_BASELINE_NOISE, "Baseline Noise");
        map.put(TAG_BASELINE_SHARPNESS, "Baseline Sharpness");
        map.put(TAG_BAYER_GREEN_SPLIT, "Bayer Green Split");
        map.put(TAG_LINEAR_RESPONSE_LIMIT, "Linear Response Limit");
        map.put(TAG_CAMERA_SERIAL_NUMBER, "Camera Serial Number");
        map.put(TAG_LENS_INFO, "Lens Info");
        map.put(TAG_CHROMA_BLUR_RADIUS, "Chroma Blur Radius");
        map.put(TAG_ANTI_ALIAS_STRENGTH, "Anti Alias Strength");
        map.put(TAG_SHADOW_SCALE, "Shadow Scale");
        map.put(TAG_DNG_PRIVATE_DATA, "DNG Private Data");
        map.put(TAG_MAKER_NOTE_SAFETY, "Maker Note Safety");
        map.put(TAG_RAW_DATA_UNIQUE_ID, "Raw Data Unique ID");
        map.put(TAG_ORIGINAL_RAW_FILE_NAME, "Original Raw File Name");
        map.put(TAG_ORIGINAL_RAW_FILE_DATA, "");
        map.put(TAG_ACTIVE_AREA, "Active Area");
        map.put(TAG_MASKED_AREAS, "Masked Areas");
        map.put(TAG_AS_SHOT_ICC_PROFILE, "As Shot ICC Profile");
        map.put(TAG_AS_SHOT_PRE_PROFILE_MATRIX, "As Shot Pre Profile Matrix");
        map.put(TAG_CURRENT_ICC_PROFILE, "Current ICC Profile");
        map.put(TAG_CURRENT_PRE_PROFILE_MATRIX, "Current Pre Profile Matrix");
        map.put(TAG_COLORIMETRIC_REFERENCE, "Colorimetric Reference");
        map.put(TAG_CAMERA_CALIBRATION_SIGNATURE, "Camera Calibration Signature");
        map.put(TAG_PROFILE_CALIBRATION_SIGNATURE, "Profile Calibration Signature");
        map.put(TAG_EXTRA_CAMERA_PROFILES, "Extra Camera Profiles");
        map.put(TAG_AS_SHOT_PROFILE_NAME, "As Shot Profile Name");
        map.put(TAG_NOISE_REDUCTION_APPLIED, "Noise Reduction Applied");
        map.put(TAG_PROFILE_NAME, "Profile Name");
        map.put(TAG_PROFILE_HUE_SAT_MAP_DIMS, "Profile Hue Sat Map Dims");
        map.put(TAG_PROFILE_HUE_SAT_MAP_DATA_1, "Profile Hue Sat Map Data 1");
        map.put(TAG_PROFILE_HUE_SAT_MAP_DATA_2, "Profile Hue Sat Map Data 2");
        map.put(TAG_PROFILE_TONE_CURVE, "Profile Tone Curve");
        map.put(TAG_PROFILE_EMBED_POLICY, "Profile Embed Policy");
        map.put(TAG_PROFILE_COPYRIGHT, "Profile Copyright");
        map.put(TAG_FORWARD_MATRIX_1, "Forward Matrix 1");
        map.put(TAG_FORWARD_MATRIX_2, "Forward Matrix 2");
        map.put(TAG_PREVIEW_APPLICATION_NAME, "Preview Application Name");
        map.put(TAG_PREVIEW_APPLICATION_VERSION, "Preview Application Version");
        map.put(TAG_PREVIEW_SETTINGS_NAME, "Preview Settings Name");
        map.put(TAG_PREVIEW_SETTINGS_DIGEST, "Preview Settings Digest");
        map.put(TAG_PREVIEW_COLOR_SPACE, "Preview Color Space");
        map.put(TAG_PREVIEW_DATE_TIME, "Preview Date Time");
        map.put(TAG_RAW_IMAGE_DIGEST, "Raw Image Digest");
        map.put(TAG_ORIGINAL_RAW_FILE_DIGEST, "Original Raw File Digest");
        map.put(TAG_SUB_TILE_BLOCK_SIZE, "Sub Title Block Size");
        map.put(TAG_ROW_INTERLEAVE_FACTOR, "Row Interleave Factor");
        map.put(TAG_PROFILE_LOOK_TABLE_DIMS, "Profile Look Table Dims");
        map.put(TAG_PROFILE_LOOK_TABLE_DATA, "Profile Look Table Data");
        map.put(TAG_OPCODE_LIST_1, "Opcode List 1");
        map.put(TAG_OPCODE_LIST_2, "Opcode List 2");
        map.put(TAG_OPCODE_LIST_3, "Opcode List 3");
        map.put(TAG_NOISE_PROFILE, "Noise Profile");
        map.put(TAG_DEFAULT_USER_CROP, "Default User Crop");
        map.put(TAG_DEFAULT_BLACK_RENDER, "Default Black Render");
        map.put(TAG_BASELINE_EXPOSURE_OFFSET, "Baseline Exposure Offset");
        map.put(TAG_PROFILE_LOOK_TABLE_ENCODING, "Profile Look Table Encoding");
        map.put(TAG_PROFILE_HUE_SAT_MAP_ENCODING, "Profile Hue Sat Map Encoding");
        map.put(TAG_ORIGINAL_DEFAULT_FINAL_SIZE, "Original Default Final Size");
        map.put(TAG_ORIGINAL_BEST_QUALITY_FINAL_SIZE, "Original Best Quality Final Size");
        map.put(TAG_ORIGINAL_DEFAULT_CROP_SIZE, "Original Default Crop Size");
        map.put(TAG_NEW_RAW_IMAGE_DIGEST, "New Raw Image Digest");
        map.put(TAG_RAW_TO_PREVIEW_GAIN, "Raw To Preview Gain");
